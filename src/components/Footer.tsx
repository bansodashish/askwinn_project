        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm">
              AI-powered automation platform for all your fashion and styling requirements. 
              Making perfect outfit selection effortless.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              <li><a href="#" className="hover:text-white transition-colors">Wedding Attire</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Party Outfits</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Corporate Wear</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Casual Styling</a></li>
        ...
        <div className="border-t border-white/10 mt-8 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © 2024 Askwinn. All rights reserved.
            </div>
